                                ...
                                <div className="flex gap-2">
                                    ...
                                    >
                                        <motion.div
                                            ...
                                            whileTap={{ scale: 0.98 }}
                                            className="flex items-center justify-center gap-2 px-4 py-2 bg-neutral-900 dark:bg-white text-white dark:text-black rounded-none text-xs font-medium hover:opacity-90 hover:underline active:underline transition-all w-full"
                                        >
                                    ...
                                    >
                                        <motion.div
                                            whileHover={{ scale: 1.02 }}
                                            whileTap={{ scale: 0.98 }}
                                            className="flex items-center justify-center gap-2 px-4 py-2 bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-white rounded-none text-xs font-medium hover:bg-neutral-200 dark:hover:bg-neutral-700 hover:underline active:underline transition-all w-full"
                                        >
